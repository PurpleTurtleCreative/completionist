...
| `show_comments`<br />⭐️ **Pro users** | Boolean (true/false)                                         | *Optional.* Default "false".                              | Set to "true" to display tasks' comments.<br /><br />This feature is available to ⭐️ **Pro users** only. |
